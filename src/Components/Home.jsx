...
function Home() {
  return (
    <main className='bg-[#222] h-screen flex items-center justify-between relative'>
        ...
        <section className='z-10 text-white px-[8%] lg:w-[70%] md:w-[80%] lg:-mt-[50px] md:-mt-[150px] mobile:-mt-[300px] -mt-[400px]'> 
        ...
        <div className='md:w-screen mobile:w-[200vw] w-[300vw] right-0 absolute bottom-0'>
            <img src={Hero}/>
        </div>
    </main>
  )
